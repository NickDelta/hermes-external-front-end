...
public class ApplicationRepositoryImpl implements ApplicationRepository {
    ...
    public List<Application> findAll(int offset, int limit) {
        var url = new URIBuilder(baseURL)
                .setPathSegments("citizen","application")
    ...
    public Optional<Application> findById(String id) {
        var url = new URIBuilder(baseURL)
                .setPathSegments("citizen","application", id)
                .build()
                .toString();
    ...
    public Integer count() {
        var url = new URIBuilder(baseURL)
                .setPathSegments("citizen","application","count")
                .build()
                .toString();
    ...
    public boolean update(Application application) {
        var url = new URIBuilder(baseURL)
                .setPathSegments("citizen","application", application.getId())
                .build()
                .toString();
